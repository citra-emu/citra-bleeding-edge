...
struct TexturingRegs {
    ...
    union {
        ...
        BitField<20, 8, u32> bias_low; // float1.5.10 TODO: unimplemented
    } proctex;

    union ProcTexNoiseConfig {
        BitField<0, 16, s32> amplitude; // fixed1.3.12
        BitField<16, 16, u32> phase;    // float1.5.10
    };
    ...
    union {
        BitField<0, 16, u32> u;  // float1.5.10
        BitField<16, 16, u32> v; // float1.5.10
