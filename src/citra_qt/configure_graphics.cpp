...
ConfigureGraphics::ConfigureGraphics(QWidget* parent)
    ...
    connect(ui->layout_combobox, SIGNAL(currentTextChanged(const QString&)), this,
            SLOT(layoutComboboxChanged(const QString&)));
    layoutComboboxChanged(ui->layout_combobox->currentText());
}

ConfigureGraphics::~ConfigureGraphics() {}

void ConfigureGraphics::layoutComboboxChanged(const QString& text) {
    if (text == "Custom") {
